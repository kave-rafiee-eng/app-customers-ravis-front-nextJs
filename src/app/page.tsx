...
const appSections: Section[] = [
  ...
  {
    title: "Phonebook",
    description: "Manage contacts with name, phone and descriptions",
    href: "phonebook",
  ...
  {
    title: "Tickets",
    description: "Review and respond to customer support tickets",
    href: "ticket",
  ...
  {
    title: "AI Documents",
    description: "Manage documents for the RAG knowledge base",
