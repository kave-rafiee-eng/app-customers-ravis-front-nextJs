...
import EditMultiGroup from "./Edit_multiGroup";
...
export default function EditMenu({
  ...
  const [menuState, setMenuState] = React.useState<menuType | null>(null);
  ...
  return (
    ...
    >
      ...
      {checkTypeMenu(menuState) == typeMenuEnum.SETTING_ON_PARAMETER && (
        <EditSettingOneParameter parentEnable={true} />
      )}

      {checkTypeMenu(menuState) == typeMenuEnum.SETTING_ON_SELECT && (
        <EditSettingOneSelect parentEnable={true} />
      )}
      ...
      {activeEdit_oneParameter && (
        <EditSettingOneParameter parentEnable={false} />
      )}

      {activeEdit_oneSelect && <EditSettingOneSelect parentEnable={false} />}
    </Stack>
  );
}
